...
uni.item.bank.06 <- readRDS(file=path(r_objects_folder, '090_uni_item_bank_06_GCPv1.rds')) 
...
item.parameters <- HarmonizationTools::get_item_parameters(summarized_response_df, 
   mplus.output = here::here('mplus_output', 'link2-06-SAGES_Telephone-uni-mlr-GCPv1.out'),
   h_obj = ggg,
...
```{r  comment=''}
  cat(readLines(here::here('mplus_output', 'link2-06-SAGES_Telephone-uni-mlr-GCPv1.out')), sep = '
')
```
