...
uni.item.bank.04 <- readRDS(file=path(r_objects_folder, '090_uni_item_bank_04_GCPv2b.rds')) 
uni.item.bank.03 <- readRDS(file=path(r_objects_folder, '090_uni_item_bank_03_GCPv2b.rds')) 
``` 
...
item.parameters <- HarmonizationTools::get_item_parameters(summarized_response_df, 
   mplus.output = here::here('mplus_output', 'link2-04-SAGESII_Telephone-uni-mlr-GCPv2b.out'),
   h_obj = ggg,
...
```{r  comment=''}
  cat(readLines(here::here('mplus_output', 'link2-04-SAGESII_Telephone-uni-mlr-GCPv2b.out')), sep = '
')
```
