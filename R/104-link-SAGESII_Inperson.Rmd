...
uni.item.bank.04 <- readRDS(file=path(r_objects_folder, '090_uni_item_bank_04.rds')) 
uni.item.bank.03 <- readRDS(file=path(r_objects_folder, '090_uni_item_bank_03.rds')) 
``` 
...
HarmonizationTools::create_summary_report(ggg, uni.item.bank.03)
```
...
item.parameters <- HarmonizationTools::get_item_parameters(summarized_response_df, 
   mplus.output = here::here('mplus_output', 'link-04-SAGESII_Inperson-uni-mlr.out'),
   h_obj = ggg,
