...
item.parameters <- HarmonizationTools::get_item_parameters(summarized_response_df, 
   mplus.output = here::here('mplus_output', 'link2-03-SAGESII_Inperson-uni-mlr-GCPv2c.out'),
   h_obj = ggg,
...
```{r  comment=''}
  cat(readLines(here::here('mplus_output', 'link2-03-SAGESII_Inperson-uni-mlr-GCPv2c.out')), sep = '
')
```
