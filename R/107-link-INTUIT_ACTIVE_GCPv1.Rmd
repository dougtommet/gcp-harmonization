...
item.parameters <- HarmonizationTools::get_item_parameters(summarized_response_df, 
   mplus.output = here::here('mplus_output', 'link2-07-INTUIT_ACTIVE-uni-mlr-GCPv1.out'),
   h_obj = ggg,
...
```{r  comment=''}
  cat(readLines(here::here('mplus_output', 'link2-07-INTUIT_ACTIVE-uni-mlr-GCPv1.out')), sep = '
')
```
