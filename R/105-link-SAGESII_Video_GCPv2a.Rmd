...
uni.item.bank.05 <- readRDS(file=path(r_objects_folder, '090_uni_item_bank_05_GCPv2a.rds')) 
...
item.parameters <- HarmonizationTools::get_item_parameters(summarized_response_df, 
   mplus.output = here::here('mplus_output', 'link2-05-SAGESII_Video-uni-mlr-GCPv2a.out'),
   h_obj = ggg,
...
```{r  comment=''}
  cat(readLines(here::here('mplus_output', 'link2-05-SAGESII_Video-uni-mlr-GCPv2a.out')), sep = '
')
```
