...
uni.item.bank.09 <- readRDS(file=path(r_objects_folder, '090_uni_item_bank_09_GCPv2a.rds')) 
...
item.parameters <- HarmonizationTools::get_item_parameters(summarized_response_df, 
   mplus.output = here::here('mplus_output', 'link-09-SAGESII_Video_validation-uni-mlr-GCPv2a.out'),
   h_obj = ggg,
...
```{r  comment=''}
  cat(readLines(here::here('mplus_output', 'link-09-SAGESII_Video_validation-uni-mlr-GCPv2a.out')), sep = '
')
```
